...
procedure TfrmNewModule.FormShow(Sender: TObject);
begin
  lbledModuleSlug.SetFocus;
end;

procedure TfrmNewModule.HandleEditorsChange(Sender: TObject);
begin
  btnOk.Enabled := CheckValidPlugin;
end;

function TfrmNewModule.CheckValidPlugin: boolean;
begin
  Result := (lbledModuleSlug.Text <> EmptyStr) and (lbledModuleName.Text <> EmptyStr);
end;
